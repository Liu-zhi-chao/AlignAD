...
class SpatialCrossAttention(BaseModule):
    ...
    @force_fp32(apply_to=('query', 'key', 'value', 'query_pos', 'reference_points'))
    def forward(self,
                query,
                key,
                value,
...
class MSDeformableAttention3D(BaseModule):
    ...
    def __init__(self,
                 ...
                 num_levels=4,
                 num_points=8,
                 im2col_step=32*2 ,    # TODO: default: 64
                 dropout=0.1,
                 use_offset=True,
                 batch_first=True,
                 norm_cfg=None,
        ...
        if reference_points.shape[-1] == 2:
            ...
            if self.use_offset:
                ...
                sampling_locations = reference_points[:, :, None, None, :, :] \
                                     + 0.5 / spatial_shapes[None, None, None, :, None, :] \
                                     * attention_weights.new_ones(
                    bs, num_query, self.num_heads, self.num_levels, self.num_points, 2)
