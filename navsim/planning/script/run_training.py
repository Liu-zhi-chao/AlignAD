...
def build_datasets(
    ...
    """
    train_scene_filter: SceneFilter = instantiate(scene_filter_cfg)
    ...
    val_scene_filter: SceneFilter = instantiate(scene_filter_cfg)
...
def main(cfg: DictConfig) -> None:
    ...
    :param cfg: omegaconf dictionary
    """
    train_val_test_log_split = load_msgpack(cfg.train_val_test_log_split_path)
    scene_filter_cfg = load_msgpack(cfg.train_test_split.scene_filter_path)
    cfg.update(train_val_test_log_split)
    ...
    if cfg.use_cache_without_dataset:
        ...
        train_data, val_data = build_datasets(cfg, agent, scene_filter_cfg)
